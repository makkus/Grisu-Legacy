...
public class User {
	...
	// // not used yet
	private final List<FileTransfer> fileTransfers = new ArrayList<FileTransfer>();

	// // not used yet
	private final List<FileReservation> fileReservations = new ArrayList<FileReservation>();
