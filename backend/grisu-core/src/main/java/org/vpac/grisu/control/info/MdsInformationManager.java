...
public class MdsInformationManager implements InformationManager {
	...
	private final Map<String, String[]> allSubmissionQueuesPerApplication = new HashMap<String, String[]>();
	//	private Map<String, String[]>
	...
	public Map<String, String> getApplicationDetails(String application,
		...
		codeDetails.put("Module", client
				.getModuleNameOfCodeForSubmissionLocation(
				site, application, version));
		codeDetails.put("SerialAvail", Boolean.toString(client
				.isSerialAvailForCodeForSubmissionLocation(
				site, application, version)));
		codeDetails.put("ParallelAvail", Boolean.toString(client
		...
		if (storageElements != null) {
			for (StorageElementType storageElement : storageElements) {
				it.infn.cnaf.forge.glueschema.spec.v12.r2.SEAccessProtocolType[] accessProtocols =
					storageElement.getAccessProtocolArray();
				...
				it.infn.cnaf.forge.glueschema.spec.v12.r2.StorageAreaType[] allStorageAreas =
					storageElement.getStorageAreaArray();
				...
				for (StorageAreaType allStorageArea : allStorageAreas) {
					String[] aclTypes =
						allStorageArea.getACL().getRuleArray();
